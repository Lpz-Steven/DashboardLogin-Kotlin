...
private val lista_frutas_verduras = listOf(
    datafrutasverduras(R.drawable.pera_1, R.string.titulo_pera, R.string.precio_pera, "Pera", "Sumérgete en la frescura y dulzura de nuestras peras cuidadosamente seleccionadas. Cosechadas en su punto justo de madurez, cada pera es una explosión de sabor refrescante y natural.", R.drawable.pera_1),
