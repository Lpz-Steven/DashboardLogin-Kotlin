...
private val listatodo = listOf(
    datatodo(R.drawable.milk_1, R.string.titulo_leches, R.string.precio_leches, "Leche", "¡Descubre la frescura y el sabor inigualable de nuestra leche! En cada sorbo de nuestra leche, encontrarás la pureza de la naturaleza y la calidad que tu familia se merece. Nuestras vacas felices y bien cuidadas nos brindan la leche más nutritiva y deliciosa,", R.drawable.milk_1),
    datatodo(R.drawable.miel_1, R.string.titulo_miel, R.string.precio_miel, "Miel", "Descubre el dulce y natural néctar que te ofrece nuestra exquisita miel. Producida por nuestras abejas en entornos prístinos, cada gota de nuestra miel es un regalo de la naturaleza. ", R.drawable.miel_1),
    datatodo(R.drawable.pollo_1, R.string.titulo_pollo, R.string.precio_pollo, "Pollo", "Deléitate con la jugosidad y el sabor inigualable de nuestro pollo fresco. Criado con cuidado y alimentado de forma natural, nuestro pollo es la opción perfecta para tus comidas saludables y deliciosas", R.drawable.pollo_1),
    ...
    datatodo(R.drawable.mantequilla, R.string.titulo_mantequilla, R.string.precio_mantequilla, "Mantequilla", "Descubre la suavidad y el sabor indulgente de nuestra mantequilla artesanal. Elaborada con los mejores ingredientes y con un proceso cuidadoso", R.drawable.mantequilla),
    ...
    datatodo(R.drawable.cerdo_1, R.string.titulo_cerdo, R.string.precio_cerdo, "Cerdo", "Descubre la excelencia de nuestra carne de cerdo premium. Criado con cuidado y alimentado de manera balanceada, nuestro cerdo ofrece una calidad insuperable en cada corte. ", R.drawable.cerdo_1),
    datatodo(R.drawable.pera_1, R.string.titulo_pera, R.string.precio_pera, "Pera", "Sumérgete en la frescura y dulzura de nuestras peras cuidadosamente seleccionadas. Cosechadas en su punto justo de madurez, cada pera es una explosión de sabor refrescante y natural.", R.drawable.pera_1),
    datatodo(R.drawable.queso_2, R.string.titulo_queso, R.string.precio_queso, "Queso", "El queso no solo es una delicia para el paladar, sino que también es un ingrediente fundamental en la cocina. Se puede disfrutar solo, en tablas de quesos exquisitos que combinan diferentes variedades.", R.drawable.queso_2),
    datatodo(R.drawable.yogurt_2, R.string.titulo_yogurt, R.string.precio_yogurt, "Yogurt", "El yogur no solo es bueno para nuestra salud, sino que también es una delicia para nuestro paladar. Viene en una amplia variedad de sabores y texturas, desde el yogur natural sin azúcar.", R.drawable.yogurt),
