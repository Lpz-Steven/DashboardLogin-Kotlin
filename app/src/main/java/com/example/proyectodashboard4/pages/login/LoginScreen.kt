    ...
    val showLoginForm = rememberSaveable {
        ...
        Surface(
            ...
            Column(
                ...
                Card(modifier = Modifier.alpha(0.8f).padding(10.dp), backgroundColor = colorResource(id = R.color.white)) {
                    Column(horizontalAlignment = Alignment.CenterHorizontally,) {
                        if (showLoginForm.value) {
                            ...
                            Text(text = "Inicia Sesion", style = TextStyle(fontWeight = FontWeight.Bold, fontSize = 20.sp, color = greenOscuro))
                            UserForm(
                            ...
                            Text(text = "Crear Cuenta Nueva", style = TextStyle(fontWeight = FontWeight.Bold, fontSize = 20.sp, color = greenOscuro))
                            UserForm(
