...
private val listaflores = listOf(
    dataflores(R.drawable.milk_1, R.string.titulo_leches, R.string.precio_leches, "Leche", "¡Descubre la frescura y el sabor inigualable de nuestra leche! En cada sorbo de nuestra leche, encontrarás la pureza de la naturaleza y la calidad que tu familia se merece. Nuestras vacas felices y bien cuidadas nos brindan la leche más nutritiva y deliciosa,", R.drawable.milk_1),
    dataflores(R.drawable.miel_1, R.string.titulo_miel, R.string.precio_miel, "Miel", "Descubre el dulce y natural néctar que te ofrece nuestra exquisita miel. Producida por nuestras abejas en entornos prístinos, cada gota de nuestra miel es un regalo de la naturaleza.", R.drawable.miel_1),
    dataflores(R.drawable.pollo_1, R.string.titulo_pollo, R.string.precio_pollo, "Pollo", "Deléitate con la jugosidad y el sabor inigualable de nuestro pollo fresco. Criado con cuidado y alimentado de forma natural, nuestro pollo es la opción perfecta para tus comidas saludables y deliciosas ", R.drawable.pollo_1),
    dataflores(R.drawable.cerdo_1, R.string.titulo_cerdo, R.string.precio_cerdo, "Cerdo", "Descubre la excelencia de nuestra carne de cerdo premium. Criado con cuidado y alimentado de manera balanceada, nuestro cerdo ofrece una calidad insuperable en cada corte. ", R.drawable.cerdo_1),
