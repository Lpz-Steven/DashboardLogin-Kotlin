...
fun TopBar(
    ...
    //TopAppBar:
    //El TopAppBar contiene:
    //
    //backgroundColor: El color de fondo de la barra, que se obtiene del tema actual
    // (MaterialTheme.colors.primary).
    //title: El título que se muestra en la barra, que es el valor actual de myTytle.
    //navigationIcon: Un botón de icono (el ícono de menú) que, al hacer clic,
    // abre el menú lateral del Scaffold.
    //actions: Una lista de acciones (botones de iconos) que se muestran en el
    // extremo derecho de la barra. En este caso, se incluyen botones de iconos para
    // refrescar, configurar y mostrar el menú desplegable.
    TopAppBar(
